...
class RestrictedFunctionsSniff extends AbstractFunctionRestrictionsSniff {
	...
	public function getGroups() {
		...
		$groups = [
			...
			'filemtime' => [
				'type'      => 'warning',
				'message'   => 'VIP does not recommend %s() as each time a container is created, it would result in a different value for files in that container. See https://docs.wpvip.com/technical-references/vip-platform/file-concatenation-and-minification/ for more info.',
				'functions' => [
					'filemtime',
				],
			],
